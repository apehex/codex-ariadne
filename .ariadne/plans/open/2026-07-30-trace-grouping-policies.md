...
This is Phase 3. The minimal index from [Phase 2](2026-07-30-static-trace-presentation-index.md) proves the partition and query model. This phase adds semantic grouping rules without adding terminal rendering or browser state.
