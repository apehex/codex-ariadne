...
The accepted presentation program is materialized as separate phase documents so each data, interaction, visual, and integration boundary can be reviewed independently:
